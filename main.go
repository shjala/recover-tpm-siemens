...
var (
	...
	testTpm = flag.Int("test", -1, "Test TPM operations:\n"+
		"\t0: Test ECDHZGen with default device key and ECC key\n"+
		"\t1: Generated a new ECC key and test ECDHZGen\n"+
		"\t2: Generate a device key and test ECDHZGen\n"+
		"\t3: Generate a new ECC key and device key, and test ECDHZGen\n\t")
)
